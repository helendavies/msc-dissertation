...
\colorlet{spotdark}{black}
\colorlet{spotlight}{black}
\colorlet{linkcolor}{black}% black!50!green
\colorlet{citecolor}{black}% black!30!red
\colorlet{urlcolor}{black}% black!30!blue
\colorlet{header}{black}
\colorlet{footer}{black}
\colorlet{marginnotes}{black}
\colorlet{newstuff}{black}
...
{\tikzexternaldisable\begin{tikzpicture}
  ...
  \ifthenelse{\equal{\chapterlabel}{}}{}{} % chapter label in right margin
