...
\new{FVB-RAG-GFP were backcrossed to NOD for 12 generations(n12).
For NOD KO-RAG-GFP mice, n12 NOD-RAG-GFP were crossed to NOD KO.
Heterozygous progeny were then crossed back to NOD KO.
...
\new{For mouse studies, investigations were carried out double or single blind, as stated in results, following ARRIVE guidelines ref ARRIVE guidelines website.}
...
Antibody clones and suppliers are shown in \fig{Add table of antibody clones and suppliers}
