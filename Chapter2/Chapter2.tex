...
Type 2 diabetes (T2D), on the other hand, is when the body becomes resistant to insulin, even though it is produced normally.
...
Type 1 diabetes affects approximately 10\% of all diabetes sufferers \toref{Diabetes UK}.}
...
\new{T and B cells both have receptors known as TcR and BcR respectively.
...
However, genetic predisposition, such as T1D susceptible MHC, and environmental factors, such as infection \citep{Filippi2008} are thought to both be very important \citep{Knip2005}, with input from both the innate and adaptive immune system, through PRR binding, inflammatory signals and activation of T and B cells \citep{Diana2011}.
...
Further evidence for B cells acting as APCs to activate autoreactive T cells comes from a study into the effect of rendering B cells MHC Class II deficient.
...
\new{The function of thymic B cells is not known.
However, it is thought they may have a role in contributing to T cell negative selection due to the fact they are seen to position themselves next to mTECs in the thymus. \toref{Starr2003,}}
