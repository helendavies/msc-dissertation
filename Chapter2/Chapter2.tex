...
\new{Diabetes mellitus is a condition affecting the body's ability to control blood sugar levels.
...
The incidence of diabetes is rising rapidly, with the prevalence of diabetes in the UK now being more than double that of 1996 \toref{Diabetes UK}.
...
There are a few types of diabetes including gestational diabetes, seen in some pregnancies, type 1 and type 2 diabetes.
Type 1 diabetes (T1D) is an antoimmune disease where the body's own immune system destroys insulin producing cells, thus resulting in a lack of insulin.
Type 2 diabetes, on the other hand, is when the body becomes resistant to insulin, even though it is produced normally.
...
\new{The immune system is a protective system that is required by all organisms in order to keep the host safe from pathogens and other injurious agents.
The immune system is designed to recognise invading pathogens and eliminate them before they can cause harm to the host.
The immune system consists of two interconnecting systems known as the innate immune system and the adaptive immune system.
The innate system is the more primitive, non specific system whereas the adaptive immune system, as the name suggests, is more adaptable to each invading pathogen, in order to mount the best possible response towards it.
...
\new{The innate immune system is characterised by being non specific, fast acting and incapable of forming immunological memory.
...
The innate immune system has numerous ways of preventing pathogen entry, such the skin and epithelial tight junctions providing physical barriers and enzymes, antimicrobial peptides and mucus to catch and kill pathogens trying to enter.
...
These receptors, such as Toll-like receptors (TLRs), C-type Lectins, NACHT-leucine rich repeat receptors (NLRs) and Rig-like receptors (RLRs) are capable of recognising a variety of patterns expressed only by microbes, known as Pathogen-associated molecular patterns (PAMPs).
Binding through receptors such as these results in signal transduction and subsequent release of inflammatory cytokines, upregulation of MHC Class II, upregulation of costimulatory molecules (vital for antigen presentation, see below), and upregulation of killing mechanisms following phagocytosis of pathogens.
...
Damaged host cells also require fixing through help from the immune system and it is thought that in order to do this, the innate immune system is also able to recognise damage-associated molecular patterns (DAMPs) which can also bind to TLRs but have the opposite effect to PAMPs so that inflammation is kept at bay in order to increase healing.}

\subsection{Adaptive}

\new{The adaptive immune system is different from the innate immune system in that it is slower acting, highly specific and has the ability to form immunological memory.
The innate immune system is concerned with tailoring the immune response to a specific pathogen.

The cells of the adaptive immune system are T and B lymphocytes, also known as T and B cells.
...
In order to activate these cells, they must first be presented with their complimentary antigen by an antigen presenting cell (APC).
...
The process of antigen presentation and lymphocyte activation will be described more fully in \cref{subsec:Tcellactivation}.

The roles of the adaptive immune cells vary.
...
Each B and T cell has a different receptor which results in a massive repertoire of B and T cell receptors, each capable of responding to a different antigen.
...
\new{For T cells to become activated, they must be presented with their cognate antigen in the peptide/MHC complex on an APC.
...
\item Signal three - Cytokines released by the APC influence the type of effector cell that the CD4\textsuperscript{+} helper T cell will become, for example Th1, Th2, Th17 \citep{Kapsenberg2003}.
\end{enumerate}}

\new{CD8\textsuperscript{+} T cells are activated differently to CD4\textsuperscript{+} T cells, in that they will only respond to MHC Class I.
...
However, for CD8\textsuperscript{+} to become activated, they need to be presented with their antigen and costimulatory molecules, only present on APCs.
...
\new{Notch is a very important transcription factor for T cell commitment.
...
Notch expression is capable of suppressing B cell lineage commitment by suppression of B cell development transcription factors, such as Pax 5 (See \cref{subsec:Bcellgenes}) so that T cell development is promoted.
...
\new{As mentioned in \cref{subsec:receptorrearrangement}, the BcR is the B cell's way of identifying pathogens in a very specific manner and there are many mechanisms in place in order to introduce high levels of diversity into the BcR repertoire.
...
The nonobese (NOD) mouse is a well described animal model of T1D, first developed by Makino et al \toref{Makino et al 1980} in 1980.
...
\new{Further evidence for the importance of B cells in T1D pathogenesis has been shown more recently through the effectiveness of B cell depletion treatments in NOD mice in the prevention/delay of T1D onset.}
...
\new{Further to this, the role of maternal autoantibodies in NOD offspring has been investigated.
...
However, 
It has been shown by different groups that maternal autoantibodies passed to offspring during pregnancy have either no effect on the offsp}

\todo{Greeley - removal of mother autoantibodies prevents T1D in offspring. Koczwara2004nods - removal makes no difference}

\todo{Rituximab preserves $\beta$ cell function in pts for a year. Pescovitz2009.
Anti-CD20 mouse - Xiu2008. Anti-CD20 in mice at 5 weeks stops diabetes, at 15 wks, delays onset}

\todo{Wong2004 Investigation of the role  of B cells in T1D. Silva2011 anti islet autoAbs triggre diabetes in the presence of an increased frequency of islet reactive CD4 T cells?}

\subsection{Antigen presentation}

\todo{Islet infiltrated B cells in NOD mouse have increased levels of costimulatory B7-1 and B7-2 molecules. This could contribute to the process of insulitis by activating T cells and causing their expansion.}

\todo{Marino2012. B cells can cross present islet antigen to activate CD8 T cells in the PLN. B cell deficiency or MHC Class I deficiency on B cells results in decreased CD8 T cells. This suggests that B cells are acting as APCs to activate cytotoxic T cells.}
...
\todo{Role of thymic B cells not known but potential role in negative selection.}
