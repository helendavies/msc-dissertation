...
The innate immune system has numerous ways of preventing pathogen entry, such as the skin and epithelial tight junctions providing physical barriers and enzymes, antimicrobial peptides and mucus to catch and kill pathogens trying to enter \citep{Janeway2001, Parkin2001}.
...
%of non self reactive T cells into the periphery and is, therefore, the first stage of T cell tolerisation. 
...
It is believed that the NOD mouse is a relevant model for T1D research as the human disease is thought to follow a similar pathogenesis.
...
More recently, the importance of B cells in T1D pathogenesis has been shown in both human diabetics and NOD mice through the effectiveness of B cell depletion treatments in the prevention/delay of T1D onset.
...
\new{It is hypothesised that B cells found in the thymus of NOD mice appear there due to their intrathymic development. 
Assuming this is the case, it is likely that these B cells will be arising from undifferentiated progenitor cells which migrate to the thymus with T cell potential, and retained B cell potential.
This forms the hypothesis that, within the thymus of NOD mice, it is expected there it would be possible to see all stages of B cell development from the very earliest committed B cell, BLP, through pro, pre and immature B cell stages to mature B cells.
%Based on this, the first aim of this project is to investigate whether early B cell progenitors and developing B cells are present in the thymus of NOD mice.
%Before carrying out any experiments, the hypothesis was that BLPs would be present in the NOD mouse thymus, as well as pro, pre and immature B cells.

For B cells to develop and be released from the bone marrow, they must successfully rearrange their BcR.
Therefore, it was hypothesised that BcR rearrangement is supported in the thymus of NOD mice. 
%With this in mind, the second aim of the project was to investigate whether this hypothesis proved true.
Further to this, it was expected that the support of BcR rearrangement in the NOD thymus is also dependent on the age of the mouse.
This is due to the fact that the disease progression in the NOD mouse is strongly age-related and therefore it was hypothesised that there would be a change in the thymic BcR rearrangement potential as NOD mice age.
It was also expected that, due to the increase in thymic B cells in older NOD mice compared to their younger counterparts, BcR rearrangement potential would be increased in older mice compared to younger mice.}
