...
Following the thymic settling of precursors, T cells progress into the double negative phase.
This means that developing T cells no not express either CD4 or CD8.
The double negative phase consists of four stages, DN1-4 and during this time, particularly in DN, the T cell receptor begins rearrangement in a similar fashion to that seen during BcR rearrangement.

After this, T cells progress to the double positive (DP) stage and express both CD4 and CD8.
In this stage, T cells undergo their first round of education, known as positive selection.
