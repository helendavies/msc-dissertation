...
The total obliteration of $\beta$ cells causes a total lack of insulin and forces the patient to rely on self monitoring of blood glucose through regular finger prick blood testing and subsequent insulin administration.
...
Each B and T cell has a unique receptor which results in a massive repertoire of B and T cell receptors, each capable of responding to a different antigen.
...
\new{Haematopoietic stem cells (HSCs) are the progenitors from which all blood cells derive.
