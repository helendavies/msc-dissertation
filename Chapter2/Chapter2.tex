...
\todo{T1D in general, how many have it, increasing incidence, complications. T1D is an autoimmune disease where $\beta$ cells are destroyed. Leave it there}
...
\new{The immune system is a protective system that is required by all organisms in order to keep the host safe from a variety of injurious agents such as bacteria and viruses.
...
The aim of the system is to prevent entry of pathogens, recognise pathogens which have managed to invade and subsequently engulf and destroy them.
...
The innate immune system has numerous ways of preventing pathogen entry, such the skin and epithelial tight junctions providing physical barriers and enzymes, antimicrobial peptides and mucus to catch and kill pthogens trying to enter.
...
Binding through receptors such as these results signal transduction and the release of inflammatory cytokines, upregulation of MHC Class II and costimulatory molecules (vital for antigen presentation, see below), and upregulation of killing mechanisms following phagocytosis of pathogens.
...
The innate immune system is concerned with tailoring the immune response to a specific antigen.

The adaptive immune system cells are T and B lymphocytes, also known as T and B cells.
These cells express receptors which are specific to a given antigen.
The adaptive immune system can therefore recognise a high number of antigens through the production of T and B cells, each with a different receptor creating a vast repertoire of receptors, each capable of responding to a different antigen.

In order to activate these cells, they must first be presented with their complimentary antigen by an antigen presenting cell.
Activation results in proliferation of the clone able to recognise the antigen and therefore results in a highly specific army of effector cells capable of fighting the pathogen.
The process of antigen presentation and lymphocytes activation will be described more fully in \cref{subsec:Tcellactivation}.

The roles of the adaptive immune cells vary.
T cells have many different subsets which be discussed in more detail below, which have different functions depending on their subset.
...
\todo{MHC presentation pathways - MHC Class II and MHC Class I}
...
\new{T cell activation requires three signals as follows \citep{Corthay2006}:
\begin{enumerate}
