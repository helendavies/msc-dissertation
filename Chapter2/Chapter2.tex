...
E2A genes encodes two transcription factors, E12 and E46.

 
   encoded proteins are also important for the production of Ly6D+ BLPs. E2A and GFi-1 share several targets and therefore are probably both important for the activation of the B cell transcriptional program \citep{Welinder2011}.

EBF-1 is also an important protein which activates a number of genes crucial to B cell development.
These include the transcription factor FOXO-1.
This transcription factor acts at the CLP stage to drive B cell development and Rag expression.
EBF-1 also acts on several components of the preBcR complex such as VPreB, a surrogate light chain for the preBcR.
Pax5 is another target of EBF-1 and this transcription factor is important for the progression in the B cell lineage and the repression of the T cell lineage by repression of Notch1 \citep{Souabni2002} (See \cref{subsec:Tcellgenes}).
