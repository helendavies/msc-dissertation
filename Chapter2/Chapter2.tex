...
The main hypotheses relate to their two main physiological roles of antibody production and antigen presentation.
...
It is thought that antigen presentation is likely to be the principal role of B cells in T1D pathogenesis.
The self-antigen presenting capabilities of B cells in T1D have been seen to be important.
For example, NOD.Igmu\textsuperscript{null} mice are not able to mount adequate CD4+ T cell responses to 
\subsection{Interference in negative selection}
