...
\new{Haematopoietic stem cells are the progenitors from which all blood cells derive.
...
\new{As mention in \cref{subsec:Tcelldevelopment}, all blood cells, including lymphocytes are formed from Lin\textsuperscript{-} Sca\textsuperscript{high} c-kit\textsuperscript{high} HSCs found in the bone marrow.
...
In man, it was found that Rituximab treatment in newly diagnosed type 1 diabetics preserved $\beta$ cell function for a year following treatment before the disease progressed again \citep{Pescovitz2009}.
...
This shows that there is conflicting evidence for the role of autoantibodies in T1D and the lack of clear cut evidence suggesting a vital role in T1D pathogenesis suggests that the production of autoantibodies is unlikely to be the only role of the B cell in T1D.
...
\new{Further evidence for the antigen presentation capacity of B cells is that NOD B cells that have infiltrated the islets in T1D appear to have increased levels of costimulatory molecules, B7-1 and B7-2 \citep{Hussain2005}. 
...
This was shown by the fact that B cell deficiency or MHC Class I deficiency selectively on B cells results in a decreased activated CD8\textsuperscript{+} T cell population \citep{Marino2012}.
