...
\todo{Recap that B cells are increased in NOD. Include references. Brief refresher. Then say we have also confirmed this}

\fig{Compare NOD to B6 in thymus and spleen. Compare B cells and T cells. Look for total thymus abnormality or just B cells. Do NOD mice just have more B cells? Hence inclusion of spleen data.}
