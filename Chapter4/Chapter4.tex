...
\todo{Can only say that the thymus can support this particular step in development, not necessarily that the pro and pre B cells found above are developing, they might leave!}
...
As shown in \cref{subfig:RAGhighlownegthyB}, there are CD19\textsuperscript{+}RAG\textsuperscript{high} cells within the thymus of NOD mice at 4, 7 and 11 weeks of age.
...
Following on from the finding of pro and pre B cells in the NOD thymus, B cell KO NOD mice thymi were also investigated.
