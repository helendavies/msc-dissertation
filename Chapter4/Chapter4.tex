...
\new{As mentioned previously in \cref{sec:thymicBcells}, it is normal for a small population of B cells, about 0.1-0.5\% of thymocytes, to be present in the thymus of both humans and mice, making up  \citep{Perera2013}.
...
A time-course study was conducted to assess the presence of mature B cells in the thymi of NOD and B6 controls that do not spontaneously develop T1D.
...
It was also neccessary to confirm that the increased thymic B cell population seen in the NOD mouse is not as a result of an overall increase in B cell production.
For example, if as NOD mice age, they produce increased numbers of B cells in the bone marrow, this would leave more B cells available to traffic
...
\begin{figure}
	...
	\end{subfigure}
\caption[NOD thymi have more B cells than B6 thymi]{B cell frequency is increased in the NOD thymus (a), but not bone marrow (b) compared to B6 controls.}
...
\todo{Move to discussion: Evidence for this comes from the findings by the likes of \citet{Perera2013} who concluded that B cell development from progenitors is more likely to be the origin of thymic B cells than migration.}
...
%It was therefore investigated whether pro and pre B cells could be seen in the thymus.
...
\todo{Scatter plot of pro and pre frequencies :(}
...
\new{In the bone marrow, progression from the pro B cell stage to the pre B cell stage requires rearrangement of the IgM heavy chains.
...
It was therefore expected that in NOD KO thymus there would also be a population of pro B cells, similar to that seen in the NOD WT mice. 
However, this does not appear to be the case.


\todo{Move to legend: Data was obtained through flow cytometric analysis in a single blind trial using 11 mice (NOD n=3, NOD KO = 4, B6 n=4). 
...
However, the frequency of pro B cells is significantly decreased in the NOD KO thymi compared to both NOD WT and B6 thymi \todo{move: (Data analysed using a One-Way ANOVA and Tukey's test). Check stats}
...
\todo{Move to legend:The experiment used 11 mice and was carried out single blind so that analysis was performed without bias.}
...
\subsection{Donor thymic B cells disappear from receipient mice following transfer}

\new{The finding that the frequency of pro B cells was decreased in NOD KO mice with respect to NOD mice suggests that a mature B cell might have an impact on the recruitment or survival of pro B cells in the thymus of NOD mice.
To investigate this, thymic cells, including thymic B cells, were transferred into NOD KO recipients to see if the transferred B cells could have an effect on the endogenous thymic pr B cell population in the NOD KO recipient.
The experimental setup is shown in \cref{fig:KOtransfersetup}.}
...
%The thymi from two donor NOD mice were taken and split into CD19+ and CD19- fraction using CD19 microbeads (Miltenyi Biotech, \cref{subsec:Miltenyibeads}).
%This was to see if the presence of thymic cells, with or without CD19\textsuperscript{+} B cells, had any effect on the presence of pro B cells in the NOD KO thymus.

Due to the preliminary nature of this transfer experiment, very small numbers of mice were used.
Donor NOD and recipient NOD KO mice were all age-matched, sex-matched female, 10 week old mice.
\todo{why was age chosen}
As shown in \cref{fig:KOtransfersetup} 2 donor NOD thymi were taken and split into CD19\textsuperscript{+} and CD19\textsuperscript{-} fractions and the fractions were then pooled.
4 recipient NOD KO mice were used, 2 received CD19\textsuperscript{+} fraction cells and 2 received CD19\textsuperscript{-} fraction cells.
One recipient each for each fraction was taken at 7 days for analysis and the others were taken at 11 days post transfer.
...
Analysis revealed that mature B cells were only present in the recipient mice at the 7 day post transfer time point, see \cref{fig:Transfer}.
...
\todo{Move to fig legend: Data was obtained from 4/5 sex-matched mice of ages stated.
...
In particular, whether or not there is a difference in frequencies of early B cell progenitors between the NOD and B6 mouse.
...
However, following the results suggesting that NOD thymi may have less thymic BLPs compared to the B6 controls, an increase in early B cell progenitors is unlikely to account for the increase in thymic B cells in the NOD.
With this in mind, it was noted that a large proportion of GFP\textsuperscript{+}CD19\textsuperscript{+} cells in the NOD thymus, were also CD4\textsuperscript{+}CD8\textsuperscript{+}.
...
Having seen GFP\textsuperscript{high}CD19\textsuperscript{+} cells in the NOD thymus suggesting active development of B cells, it was then noted that a large percentage of these cells were also CD4\textsuperscript{+}CD8\textsuperscript{+} \cref{subfig:ThyRAGCD19DP}.
...
As shown in \cref{subfig:GFPtransfersetup}, two donor thymi from NOD-RAG-GFP mice were taken and split into CD19\textsuperscript{+} and CD19\textsuperscript{-} fractions using Miltenyi CD19 microbeads (See \cref{subsec:Miltenyibeads}).
CD19\textsuperscript{+} fractions from both donors were then pooled and the same was done for the CD19\textsuperscript{-} fractions.
Four recipient NOD mice were then injected with either CD19\textsuperscript{+} or CD19\textsuperscript{-} thymic cells from the donors.
...
%This tissue was included to look at the inflammatory status of the lymph node to compare it to the control axillary lymph node.
