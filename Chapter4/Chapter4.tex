...
The positioning of the gates was determined using the bone marrow as a tissue control where clear populations of CD19\textsuperscript{+}, IgM\textsuperscript{-} cells could be seen. These gates were then applied to the thymus. The divide between CD43\textsuperscript{+} and CD43\textsuperscript{-} was also determined by looking at bone marrow samples. 
Subsequent experiments could include isotype controls to show true negative populations for each marker. 
