...
It is not clear whether the increased frequency of thymic B cells in NOD mice compared to non-NOD mice is age-related; that is the increased population of thymic B cells correlates with a specific stage of the T1D process.
...
However, by 9 weeks of age the time when insulitis is well established and initial CTL activity to beta cells is active, there is a significant increase in both the frequency and absolute numbers of thymic B cells in NOD mice with respect to control B6 mice. 
...
It is unclear whether similar populations occur in NOD mice, and if their frequencies correlate with disease progression. 
...
As shown in \cref{subfig:MatureBincproBgraph}, the difference between the NOD and B6 is not significant suggesting that an increase in pro B cells does not correlate with the increased mature B cells seen in the NOD mouse thymus.
...
\begin{figure}
	\begin{subfigure}{\textwidth}
	\caption{}
	\includegraphics[width=0.9\textwidth]{Figures/MatureBincproB.png}
	\end{subfigure}
	\begin{subfigure}{\textwidth}
	\centering
	\caption{}
	\includegraphics[width=0.9\textwidth]{Figures/B6NODKOBM.png}
	\label{subfig:KOBM}
	\end{subfigure}
	\begin{subfigure}{\textwidth}
	\centering
	\caption{}
	\includegraphics[width=0.4\textwidth]{Figures/MatureBincproBgraph.pdf}
...
\subsection{Transfer of mature thymic B cells may promote endogenous thymic B cell development}
...
To investigate this, a pilot study was performed whereby thymic cells, including thymic B cells, were isolated from NOD mice and transferred into NOD KO mice.
The aim of this transfer was to examine whether transferred NOD thymic B cells can have an effect on the endogenous thymic pro B cell population in the NOD KO recipient.
...
Ten week old donor mice were chosen because these mice have significantly increased B cells in their thymus compared to B6 controls.
...
Purity of the cell populations was determined by cytometry (see \cref{Figures/NODdonor.png}) and the two cell populations were injected into appropriated labelled NOD KO recipients.
The recipient mice were assessed at 7 days and 11 days following transfer of donor cells to determine the initial and long term population of various tissues with mature B cells and/or the initiation of B cell development at the level of pro B cells (see \cref{fig:KOtransfersetup}).
...
While the use of congenic mice, where the donor and recipient bear, for example, CD45.1 versus CD45.2 molecules, respectively on their immune cells, would enable tracking of donor cells in recipient mice.
Unfortunately these mice were not available for this project.
As an alternative, it was speculated that NOD-RAG-GFP mice, in which donor cells could be identified by GFP expression,
...
As shown in figure \cref{fig:Transfer}, flow cytometric analysis revealed that mature B cells (CD19+IgM+) were only present in the recipient mice at the 7 day post transfer time point.
...
Interestingly, no mature B cells were detectable in the bone marrow or any lymph node analysed (Data not shown).
In contrast, both the spleen (A) and thymus (B) of NOD KO mice contained mature B cells.
...
A caveat with the previous result is that inability to distinguish between contaminating transferred B cells and those that formed from endogenous progenitors.
In addition, with the previous transfer, the assumption is made that the only defect within the thymus is the lack of mature B cells.
However, it may be that other factors, such as stromal signalling, may be defective and so to control for this, a transfer using only NOD mice, where the donor expresses a reporter indicative of B cell development, was performed.

While the use of congenic mice, where the donor and recipient bear, for example, CD45.1 versus CD45.2 molecules, respectively on their immune cells, would enable tracking of donor cells in recipient mice.
Unfortunately these mice were not available for this project.
It was, therefore, speculated that NOD-RAG-GFP mice, in which mature B cells could be tracked via their GFP expression, could serve as an alternative donor mouse.
In this regard CD19\textsuperscript{+}GFP\textsuperscript{+} would still be present a few days post transfer due to the slow kinetics of GFP degradation.
...
definitive evidence of development rather than just markers
...
This finding confirms that the NOD thymus supports rearrangment of the NOD BcR, as no Cd19+GFP+ cells would be detectable if it did not.
...
If B cells are developing within the thymus, this begs the question as to whether the NOD thymus is providing an environment more conducive to B cell development compared to control B6 mice. 
...
Non-quantitative RT-PCR was performed to compare whether or not B cell development transcription factors are present in the NOD bone marrow and thymus.
...
This reinforces that the thymic environment promotes B cell development.
...
\todo{Time constraints stopped quantitative PCR.}
...
As shown in FIGURE, approximately 69.2\% of thymic GFPhighCD19pos cells also co-expressed CD4 and CD8 molecules.
In contrast, only approximately5.14\% of GFPlwoCD19+ cells also co-expressed these T cell markers.
This uniqueness for GFPhigh CD19+ cells to co-express CD4 and CD8 molecules was restricted to the thymus, as similar analysis of both the bone marrow and spleen revealed 0.016\% (fig) and 0.38\% (fig) of GFP+CD19+ cells co-express CD4 and CD8 molecules, respectively.
...
These RAGCD19CD4CD8 cells are present in the thymus of NOD mice at both 4 and 7 weeks of age and their frequencies \todo{Significance in graph without outlier}  and it was therefore investigated whether or not there was a significant difference in the percentages of these cells between the two age groups. 
The bone marrow is also included in the figure as a comparison.
However, the results show that there is no difference in presence of RAG\textsuperscript{high}CD19\textsuperscript{+}CD4\textsuperscript{+}CD8\textsuperscript{+} cells between the two ages. E!!!!
...
This could suggest that these cells are just late at committing to a lineage, or it may be that they are the mid point of either a T or B cell transitioning to the other. or unique population of thymocyte.
