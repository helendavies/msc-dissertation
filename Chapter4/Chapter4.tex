...
\new{\citet{Akashi2000} has shown pro and pre B cells in the thymus. To confirm this, and to see if they are present in the NOD... }
...
\new{The donor thymi were taken from the donor mice and split into CD19\textsuperscript{+} and CD19\textsuperscript{-} fractions using CD19 microbeads (Miltenyi).
