...
As mentioned in \toref{Background on Rag expression in developing T and B cells}, Rag is expressed in both T and B cells during rearrangment of the TcR or BcR respectively.
With the use of the NOD-RAG-GFP reporter mouse (See \toref{Methods on mice}), Rag expression can be seen indirectly via the expression of GFP which is visible on flow cytometry.
