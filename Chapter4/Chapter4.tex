...
Pro (CD19\textsuperscript{+}IgM\textsuperscript{-}CD43\textsuperscript{+}) and pre (CD19\textsuperscript{+}IgM\textsuperscript{-}CD43\textsuperscript{-}) B cells within a live, CD19\textsuperscript{+}, single cell gate were identified by flow cytometry.
...
Gating strategy is shown in \ref{subfig:MatBincreasesthyProBgating}.
...
\begin{figure}	
	...
	\centering
	\caption{Thymus}
	\includegraphics[width=0.80\textwidth]{Figures/GFPCD19CD4CD8.png}	
...
Cells were isolated from the thymus, bone marrow and spleen of 4 (n= ) and 7 (n= ) week old NOD mice.
...
The gating pattern to identify CD4\textsuperscript{+}CD8\textsuperscript{+}CD19\textsuperscript{+} in GFP\textsuperscript{+} and GFP\textsuperscript{-} populations is shown in \ref{subfig:ThyRAGCD19DP}.
...
\subsection{RAG\textsuperscript{+}IgM\textsuperscript{+}TcR$\beta$\textsuperscript{+} cells are present in the NOD thymus}
...
%However, if the populations were found to be linked, it may be that IgM\textsuperscript{+}TcR$\beta$\textsuperscript{+} cells are the result of RAG\textsuperscript{+}CD19\textsuperscript{+}CD4\textsuperscript{+}CD8\textsuperscript{+} development, or that they are 
...
\begin{figure}
	\begin{subfigure}{\textwidth}
	\caption{}
	\includegraphics[width=0.8\textwidth]{Figures/ThyvBMIgMTcR.png}	
	\label{subfig:BMvThyRAGIgMTcR}
	\end{subfigure}
	\begin{subfigure}{\textwidth}
	\caption{}
	\includegraphics[width=0.5\textwidth]{Figures/NewTcRIgMgraph.pdf}	
...
Statistical significance in frequencies between the two tissues was determined using an unpaired T test and found to be significant, P=0.0206 (P<0.05 is deemed to be significant). 
