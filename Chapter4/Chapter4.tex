...
As shown in \cref{fig:MatureBincProBgraphs}, the frequency of pro B cells is significantly decreased in the NOD KO thymi compared to both NOD WT and B6 thymi (Data analysed using a One-Way ANOVA and Tukey's test).
...
On the other hand, due to the fact that the group size is very small, one mosue per group, the results must be viewed with caution.
